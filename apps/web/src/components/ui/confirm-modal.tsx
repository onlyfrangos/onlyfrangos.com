      ...
      <div className="w-full max-w-sm rounded-2xl border border-of-border bg-of-surface p-5 shadow-2xl">
        <div className="flex justify-end">
          <button
            ...
            onClick={onClose}
            disabled={loading}
            className="rounded-lg p-1.5 text-of-muted hover:bg-white/5 hover:text-of-text"
            aria-label="Fechar"
          >
            <X className="h-5 w-5" />
          </button>
        </div>
        <h2 id="confirm-modal-title" className="text-lg font-semibold text-of-text">
          {title}
        </h2>
        ...
        <div className="mt-5 flex justify-end gap-2">
          <button
            ...
            onClick={onClose}
            disabled={loading}
            className="rounded-xl border border-of-border px-4 py-2 text-sm hover:bg-white/5"
          >
            Cancelar
          </button>
          <button
